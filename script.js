...
const doctors = [['doctor-1.png','Dr. Talaat Al Qadi'],['doctor-2.png','Dr. Gaith Helal'],['doctor-3.png','Dr. Mai Abdelraouf'],['doctor-4.png','Dr. Manal Dandan'],['logo-original.png','Dr. Amr Hassoun'],['logo-original.png','Dr. Ihssan Tayseer'],['logo-original.png','Dr. Claude Istanbouli']];
...
const doctorProfiles = {
  ...
  may:{name:'Dr. Mai Abdelraouf',role:'General Dentist',summary:'Dr. Mai Abdelraouf is a General Dentist with 20 years of experience in the UAE. She holds a Master’s degree in Dental Laser and has extensive experience across general, restorative, and cosmetic dental treatments.',image:'assets/doctors-may.png',experience:['20 years of clinical experience in the UAE','Advanced training in dental laser treatment'],education:[['Bachelor of Dental Surgery','Misr University for Science and Technology'],['Master’s Degree in Dental Laser','RWTH Aachen University, Germany']],expertise:['Tooth extractions','Crowns and fillings','Root canal treatments','Cosmetic dental procedures']},
